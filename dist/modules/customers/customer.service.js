...
const getMealReview = async (mealId) => {
...
const createProviderProfile = async (userId, data) => {
    ...
    try {
        return await prisma.$transaction(async (tx) => {
            ...
            if (existingUser) {
                throw new AppError(status.BAD_REQUEST, "Provider profile is already exists");
            }
...
export const addToCart = async (customerId, mealId, qty) => {
