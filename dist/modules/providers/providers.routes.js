...
const router = Router();
/* Get my meals */
router.get("/provider-meal", auth(UserRole.PROVIDER), providerController.getMyMeals);
...
/* Delete Meal */
router.delete("/provider-meal/:id", auth(UserRole.PROVIDER), providerController.deleteMeal);
